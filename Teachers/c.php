...
<?php if(isset($_GET['edit_cat'])){ 
          echo edit_cat();
                    ...
                    <input type="text" class="form-control" name="c_name" placeholder="Enter Course Name"/> <br />
                    <input type="text" class="form-control" name="c_des" placeholder="Enter Course Description"/> <br />
                    ...
                    <input type="text" class="form-control" name="creator" placeholder="Enter Creator Name"/> <br />
